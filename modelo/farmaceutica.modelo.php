...
class ModeloFarmaceuticas{
    ...
    static public function mdlCrearFarmaceutica($tabla, $datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre, pais, ciudad, direccion, telefono, email) VALUES (:nombre, :pais, :ciudad, :direccion, :telefono, :email)");
    ...
    static public function mdlEditarFarmaceutica($tabla, $datos){
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre=:nombre, pais=:pais, ciudad=:ciudad, direccion=:direccion, telefono=:telefono, email=:email WHERE id=:id");
